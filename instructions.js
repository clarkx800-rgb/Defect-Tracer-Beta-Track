const systemInstructions = `
    <div style="font-size: 15px; line-height: 1.5; color: var(--text-color); text-transform: none; padding-bottom: 20px; font-family: sans-serif;">
        ...
        <div style="text-align: center; margin-bottom: 20px; color: var(--text-muted);">
            ...
            <div style="margin-top: 12px; font-size: 14px; color: var(--warning); font-weight: bold; border: 2px solid var(--warning); display: inline-block; padding: 8px 12px; border-radius: 4px; background: rgba(255, 179, 0, 0.1);">
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 20px; background: rgba(255,255,255,0.05); padding: 15px; border: 2px solid var(--border-color); border-radius: 8px;">
            ...
            <div>
                ...
                <p style="margin: 0 0 8px 0; font-size: 15px; font-weight: 500;">Tap the top-right <b>⚙ menu</b>. Pick your Line, Direction, and Section. Tap <b style="color: var(--primary);">LOAD AREA</b>.</p>
                <div style="background: var(--bg-color); padding: 10px; border-radius: 4px; border-left: 3px solid var(--primary); font-size: 14px;">
                    <b>TIP:</b> Walking the other way? Hit <b>🔃 FLIP DIR</b> to reverse the track order.
                </div>
            </div>
        </div>
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 20px; background: rgba(255,255,255,0.05); padding: 15px; border: 2px solid var(--border-color); border-radius: 8px;">
            ...
            <div>
                ...
                <p style="margin: 0 0 8px 0; font-size: 15px; font-weight: 500;">Pick a <b>COMPONENT</b> and <b>DEFECT</b>. Tap <b>📷 PHOTO</b> to attach pictures. Don't waste time typing out full work orders here.</p>
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 20px; background: rgba(255,255,255,0.05); padding: 15px; border: 2px solid var(--border-color); border-radius: 8px;">
            ...
            <div>
                ...
                <ul style="margin: 0; padding-left: 20px; font-size: 15px; font-weight: 500; line-height: 1.6;">
                    ...
                    <li style="margin-bottom: 8px;"><b>+ (Batch Add):</b> Add multiple track sections to your list all at once.</li>
                    ...
                    <li><b>Insert Track:</b> Long-press any TS on the left map to insert a pocket or switch.</li>
                </ul>
            </div>
        </div>
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 20px; background: rgba(255,255,255,0.05); padding: 15px; border: 2px solid var(--border-color); border-radius: 8px;">
            ...
            <div>
                ...
                <p style="margin: 0 0 8px 0; font-size: 15px; font-weight: 500;">When the inspection is totally done, hit <b>💾 SAVE</b> to back it up, then tap <b style="color: var(--success);">📊 EXPORT REPORT</b>.</p>
                <div style="background: var(--bg-color); padding: 10px; border-radius: 4px; border-left: 3px solid var(--success); font-size: 14px;">
                    Take the generated Excel file and PDFs back to the shop to process your work orders.
                </div>
            </div>
        </div>
